...
from executor import PredictStateAtPlannerFinishExecutor, FinishActionsAndUseStatePredictionExecutor, FinishActionsExecutor
...
if __name__ == "__main__":
    ...
    executor = FinishActionsExecutor(args.planning_time)
